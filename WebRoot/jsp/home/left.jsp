...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>办案区信息管理
        ...
        <li><cite></cite><a href="${pageContext.request.contextPath }/personalCheck_loadInfor.action" target="rightFrame">安全检查-人身检查</a><i></i></li>
        <li><cite></cite><a href="${pageContext.request.contextPath }/belonging_loadInfor.action" target="rightFrame">安全检查-随身物品登记</a><i></i></li>
        ...
        <li><cite></cite><a href="${pageContext.request.contextPath }/jsp/recordInformation/PHCSMP_Leave_Record.jsp" target="rightFrame">出区信息登记</a><i></i></li>
        </ul>    
    </dd>
